                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-primary btn-sm order-products"
                                                    data-url="{{ route('dashboard.order.product', $order->id) }}"
                                                    data-method="get"
                                            >
                                                ...
                                                <a href="{{ route('dashboard.client.order.edit', ['client' => $order->client->id, 'order' => $order->id]) }}" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> @lang('site.edit')</a>
